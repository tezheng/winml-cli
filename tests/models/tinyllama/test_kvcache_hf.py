...
def test_prefill_then_decode_layer0(hf_model):
    ...
    tl_layer.load_hf_tinyllama_layer(api_blk, hf_model.state_dict(), layer_idx=0)
    api_blk.eval()
    ...
    print(f"TinyLlama 1.1B prefill max_abs_diff={pre_diff:.3e}, decode max_abs_diff={dec_diff:.3e}")
